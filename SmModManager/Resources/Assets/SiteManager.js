...
setTimeout(function () {
    ...
    if (!currentUrl.includes("chat")) {
        if (currentUrl.includes("friends")) {
            var x = [document.getElementsByClassName("selectable friend_block_v2 persona in-game "), document.getElementsByClassName("selectable friend_block_v2 persona online "), document.getElementsByClassName("selectable friend_block_v2 persona offline ")];
